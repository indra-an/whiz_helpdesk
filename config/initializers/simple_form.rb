...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_input_group, tag: "div", class: "form-group", error_class: "has-error" do |b|
    b.use :html5
    b.use :placeholder
    b.use :label, class: "control-label", style: "text-align: left"

    b.wrapper tag: "div" do |ba|
      ba.wrapper tag: "div", class: "input-group col-sm-6" do |append|
  ...
  1.upto(12) do |col|
    config.wrappers "inline_field#{col}".to_sym, tag: "div", class: "col-sm-#{col}", error_class: "has-error" do |ic|
      ...
      ic.use :input, class: "form-control", style: "margin-bottom:10px"
